...
/*[hidden]*/
diameter_ball=8;
screw_length=clamp_length+(clamp_thickness-12)-diameter_ball - (clamp_length - minimum_clamp_opening);
rounding=2;
...
module bolt(){
    knurled_cyl(knob_length, knob_diameter, 3, 3, 1, 2, 50);
