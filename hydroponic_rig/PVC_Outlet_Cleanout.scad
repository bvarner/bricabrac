...
difference() {
    union() {
        ...
        translate([0, 2/3 * pipe_id / 2 - 1.05, 7/8 * 25.4 + 10])
        rotate([180, 0, 0])
    ...
    rotate([180, 0, 0])
    {
        translate([0, 2/3 * pipe_id / 2 - 1.05, 0]) {
            ...
            translate([0, 0, 1 * 25.4]) {
                ...
                translate([0, 0, 1/16 * 25.4]) {
                    sphere(d = 1/2 * 25.4);
                    rotate([90, 0, 0]) 
                        cylinder(d = 1/2 * 25.4, h = 2 /3 * pipe_id / 2 - 1.05);
                }
            }
        }
        ...
        union() {
            ...
            translate([0, 0, (1 + 1/16) * 25.4]) {
                ...
                for (rz = [-90 : 90 : 90]) {                    
                    rotate([0, 0, 90 + rz]) 
                        rotate([0, 90, 0]) 
                            cylinder(d = 3/8 * 25.4, h = (pipe_id / 2) - 1/2 * 25.4);
                }
